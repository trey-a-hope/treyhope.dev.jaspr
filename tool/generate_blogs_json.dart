...
// run "dart run tool/generate_blogs_json.dart" to sync blogs.json with web/blogs/ dir
...
// For Claude to update images
  ...
  // - "Convert Medium URLs to local images in web/blogs/2024-05-23-coffee-code-working-with-nakama/"
