<!-- content/blogs/2024-12-20-my-first-post.md -->
---
title: Coffee & Code - Creating Custom User Flows for Development with Miro
date: 2024-04-27
slug: coffee-code-creating-custom-user
author: Trey Hope
tags: flutter, miro, userflows
excerpt: I decided to try out Miro because of it’s simplicity and recommendation from other developers.
---

# Coffee & Code - Creating Custom User Flows for Development with Miro

**I decided to try out Miro because of it’s simplicity and recommendation from other developers.**
...
![1_AFzsEc4-VRCDK6OU3NljVQ.gif](./1_AFzsEc4-VRCDK6OU3NljVQ.gif)
...
![1_bFxptW--kGEt4GnMA03hvw.gif](./1_bFxptW--kGEt4GnMA03hvw.gif)

> My example user flow for the project.
> 

There are several softwares available to create user flows, including [**ClickUp**](https://clickup.com/) and [**Figma**](https://www.figma.com/), but I decided to try out [**Miro**](https://miro.com/) because of it’s simplicity and recommendation from other developers.
...
![1_q7kz1cC_AhpBOuhJogplvw.gif](./1_q7kz1cC_AhpBOuhJogplvw.gif)

> [**Article**](https://medium.com/@flutterwtf/mobile-app-design-process-91de3fa9cf6c) from What The Flutter about a strong mobile app design process.
> 
